...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(users, jwt) {
            this.users = users;
            this.jwt = jwt;
        }
        // REGISTER
        AuthService_1.prototype.register = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var existing, hashed, user, payload, token, e_1;
                var _a;
                    ...
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, this.users.create({
                                    email: dto.email,
                                    password: hashed,
                                    role: (_a = dto.role) !== null && _a !== void 0 ? _a : client_1.UserRole.PATIENT,
                                    phone: dto.phone,
                                })];
                        case 4:
                            user = _b.sent();
        ...
        AuthService_1.prototype.login = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, valid, payload, token;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!dto.email) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.users.findByEmail(dto.email)];
                        case 1:
                            user = _a.sent();
                            return [3 /*break*/, 4];
                        case 2:
                            if (!dto.phone) return [3 /*break*/, 4];
                            return [4 /*yield*/, this.users.findByPhone(dto.phone)];
                        case 3:
                            user = _a.sent();
                            _a.label = 4;
                        case 4:
