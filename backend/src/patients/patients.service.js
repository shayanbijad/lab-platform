...
var PatientsService = function () {
    ...
    var PatientsService = _classThis = /** @class */ (function () {
        ...
        PatientsService_1.prototype.create = function (userId, data) {
        ...
        PatientsService_1.prototype.getPatientById = function (patientId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.patient.findUnique({
                            where: { id: patientId },
                            include: {
                                user: {
        ...
        PatientsService_1.prototype.getPatientByUserId = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.patient.findUnique({
                            where: { userId: userId },
